 ...
 */
export function gradientDescentLinearRegression(X, y, learningRate, iterations) {
    ...
    for (let iter = 0; iter < iterations; iter++) {
        ...
        const gradient = math.multiply((1/m), math.multiply(math.transpose(X_matrix), errors));
